...
public:
    ...
    std::shared_ptr<InputAction> Escape; /// \brief The input action associated with the Escape key, typically used to pause the game or access the menu.
    std::shared_ptr<InputAction> LeftStrafe; /// \brief The input action associated with strafing left.
    std::shared_ptr<InputAction> RightStrafe; /// \brief The input action associated with strafing right.

...
struct PerspectiveCamera {
    ...
    engine::Rect extent; /// \brief The visible area of the camera in the scene.
    ...
    PerspectiveCamera(const engine::Rect extent = engine::Rect{ engine::Vec2::zero(), engine::Vec2{1920.0f, 1080.0f} },

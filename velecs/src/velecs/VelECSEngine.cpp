...
VelECSEngine& VelECSEngine::Init()
{
...
// VelECSEngine& VelECSEngine::SetInput(std::unique_ptr<IInput> input)
// {
...
VelECSEngine& VelECSEngine::Cleanup()
{
    if (_isInitialized)
    {
        ecsManager->Cleanup();
...
void VelECSEngine::Draw(const float deltaTime)
{

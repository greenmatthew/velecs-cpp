...
class MenuInputActionMap : public velecs::InputActionMap {
public:
    // Enums

    // Public Fields
    
    std::shared_ptr<velecs::InputAction> Escape; /// \brief The input action associated with the Escape key, typically used to exit a menu.
